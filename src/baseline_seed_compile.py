...
if __name__ == '__main__':
    ...
    for model_type in model_names:
        ...
        for seed in seeds:
            ...
            val_accuracy_df = pd.read_csv(os.path.join(analysis_path, 'val_predictions', 'val_accuracies.csv'))
            results.append(val_accuracy_df[languages])
        ...
        all_accuracy_df.to_csv(f'./experiments/sweeps/seed/{model_type}/val_accuracy_across_seeds.csv')
