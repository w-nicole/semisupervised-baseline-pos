...
save_path=${4:-"./experiments/frozen_concat/phase_2"}

src="English"
tgt="English Dutch"

data_path=${5:-"../ud-treebanks-v1.4"}
encoder_checkpoint=${6:-"./experiments/frozen_concat/phase_1/lr_5e-5_size_0_layers_-1/version_0/ckpts/ckpts_epoch=3-val_English_acc=95.332.ckpt"}
