...
save_path=${4:-"./experiments/normal/large/auxiliary"}
...
python3 src/train_decoder_base.py \
    ...
    --exp_name phase_2_auxiliary_l_"$aux_layers"_h_"$aux_hidden_size"_s_"$aux_size" \
    --gpus 1 \
    --encoder_checkpoint "$encoder_checkpoint" \
    --decoder_hidden_layers 2 \
    --decoder_hidden_size 32 \
    --auxiliary_hidden_layers $aux_layers \
    --auxiliary_hidden_size $aux_hidden_size \
