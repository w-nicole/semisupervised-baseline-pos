...
# Edited arguments and added lr search.
...
decoder_checkpoint=${6:-"./experiments/decoder_for_baseline/version_0/ckpts/ckpts_epoch=9-decoder_loss=54.182.ckpt"}
...
for lr in 1e-2 1e-3 1e-4; do
    python3 src/train_decoder.py \
        ...
        --exp_name decoder_baseline_lr_search \
        --gpus 1 \
