...
save_path=${1:-"./experiments/baseline/English/mbert_pretrained/encoder_pretrained/decoder_pretrained/kl_0.1"}
...
decoder_checkpoint=${5:-"./experiments/components/mbert_pretrained/decoder/linear/version_1/ckpts/ckpts_epoch=9-val_English_decoder_loss=63.230.ckpt"}
bs=16
ep=2
lr=0.005
