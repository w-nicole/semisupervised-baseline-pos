...
checkpoint=${3:-"./experiments/random_mask/english/individual/mask_probability=0.5/version_gidv4ts8/ckpts/ckpts_epoch=18-val_English_pos_acc_epoch=60.359.ckpt"}
