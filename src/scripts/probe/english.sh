...
save_path=${1:-"./experiments/probe/english"}
train_languages="English"
val_languages="English Dutch Turkish"
data_path=${2:-"../../ud-treebanks-v1.4"}
checkpoint=${3:-"./experiments/latent_space/english/english/version_18utezpe/ckpts/ckpts_epoch=19-val_all_MSE_epoch=115.739.ckpt"}
