...
checkpoint=${3:-"./experiments/random_mask/english/individual/mask_probability=0.75/version_dfa6vqk1/ckpts/ckpts_epoch=19-val_English_pos_acc_epoch=38.699.ckpt"}
