...
save_path=${4:-"./experiments/huggingface/phase_3"}

src="English Dutch"
tgt="English Dutch"
data_path=${5:-"../ud-treebanks-v1.4"}
decoder_checkpoint=${6:-"./experiments/huggingface/phase_2/linear_lr_1e-2_bs16/version_0/ckpts/ckpts_epoch=1-val_English_decoder_loss=164.720.ckpt"}
