...
save_path=${4:-"./experiments/phase_3_optimization/phase_3/dutch_to_dutch"}

src="Dutch"
tgt="English Dutch"
data_path=${5:-"../ud-treebanks-v1.4"}
decoder_checkpoint=${6:-"./experiments/phase_3_optimization/phase_2/dutch/linear_lr_1e-1_bs16/version_0/ckpts/ckpts_epoch=2-val_Dutch_decoder_loss=107.534.ckpt"}
