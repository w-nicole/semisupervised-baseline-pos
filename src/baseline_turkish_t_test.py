...
if __name__ == '__main__':
    ...
    theirs_all = {
        ...
        'fixed_val_acc_epoch_10' : [0.5785133242607117, 0.5596475601196289, 0.5695887804031372, 0.5723000168800354, 0.5799819231033325]
    }
    theirs_key = 'fixed_val_acc_epoch_10'
